...
import com.ketal.qemoji.HookEntry;
import com.ketal.qemoji.R;
import com.ketal.qemoji.data.HostInformationProviderKt;

import static com.ketal.qemoji.utils.LogUtilsKt.loge;
import static com.ketal.qemoji.utils.LogUtilsKt.logi;
import static com.ketal.qemoji.utils.UtilsKt.getAppContext;
import static com.ketal.qemoji.utils.UtilsKt.getObjectOrNull;
            ...
            if (sModulePath == null) {
                ...
                for (Object element : dexElements) {
                    ...
                    if (file != null && !file.isDirectory()) {
                        ...
                        if (modulePath == null || !modulePath.contains("com.ketal.qqcleaner")) {
                            modulePath = path;
                        }
                    }
                }
    ...
    public static class MyInstrumentation extends Instrumentation {
        ...
        public Activity newActivity(ClassLoader cl, String className, Intent intent) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
            try {
                ...
                if (className.startsWith("com.ketal.qqcleaner")) {
            ...
            if ("startActivity".equals(method.getName())) {
                ...
                if (index != -1) {
                    ...
                    if (hostApp != null && component != null
                            ...
                            && (component.getClassName().startsWith("com.ketal.qqcleaner."))) {
